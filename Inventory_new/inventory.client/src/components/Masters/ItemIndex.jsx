            ...
            <div className="p-2 bg-[#e2ebf8]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-2 mb-2">
                    ...
                    <div className="md:col-span-8 bg-white p-3 border border-blue-200 rounded shadow-sm">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-4 gap-y-2">
                            <div className="flex items-center gap-2">
                                ...
                                <input name="name" value={form.name} onChange={handleChange} className="flex-1 border border-slate-300 p-1 text-xs outline-none focus:border-blue-500" placeholder="Item Name"/>
                            </div>
                            <div className="flex items-center gap-2">
                                <span className="w-24 text-[11px] font-semibold text-slate-600">Arabic Name</span>
                                <input name="arabicName" value={form.arabicName} onChange={handleChange} className="flex-1 border border-slate-300 p-1 text-xs outline-none focus:border-blue-500 text-right" placeholder="Arabic Name"/>
                            </div>
                            <div className="flex items-center gap-2">
                                <span className="w-24 text-[11px] font-semibold text-slate-600">Part No</span>
                                <input name="partNo" value={form.partNo} onChange={handleChange} className="flex-1 border border-slate-300 p-1 text-xs outline-none focus:border-blue-500" />
                            </div>
                            <div className="flex items-center gap-2">
                                <span className="w-24 text-[11px] font-semibold text-slate-600">SAP No</span>
                                <input name="sapNo" value={form.sapNo} onChange={handleChange} className="flex-1 border border-slate-300 p-1 text-xs outline-none focus:border-blue-500" />
                            </div>
                            <div className="flex items-center gap-2">
                                <span className="w-24 text-[11px] font-semibold text-slate-600">Category</span>
                                <div className="flex flex-1">
                                    <input name="category" value={form.category} onChange={handleChange} className="w-full border border-slate-300 p-1 text-xs outline-none focus:border-blue-500" />
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <div className="flex flex-1">
                                    <input name="group" value={form.group} onChange={handleChange} className="w-full border border-slate-300 p-1 text-xs outline-none focus:border-blue-500" />
                                    <button className="bg-slate-200 px-1.5 border border-l-0 border-slate-300 hover:bg-slate-300"><Search size={12}/></button>
                                </div>
                            </div>
                            <div className="flex items-center gap-2">
                                ...
                                <div className="flex flex-1">
                                    <input name="brand" value={form.brand} onChange={handleChange} className="w-full border border-slate-300 p-1 text-xs outline-none focus:border-blue-500" />
                                    <button className="bg-slate-200 px-1.5 border border-l-0 border-slate-300 hover:bg-slate-300"><Search size={12}/></button>
                                </div>
                            </div>
                            <div className="flex items-center gap-2">
                                <span className="w-24 text-[11px] font-semibold text-slate-600">Rack / Location</span>
                                <input name="rack" value={form.rack} onChange={handleChange} className="flex-1 border border-slate-300 p-1 text-xs outline-none focus:border-blue-500" />
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-4 gap-y-2">
                             <div className="flex items-center gap-2">
                                ...
                                <input name="unit" value={form.unit} onChange={handleChange} className="flex-1 border border-slate-300 p-1 text-xs outline-none focus:border-blue-500" />
                            </div>
                            <div className="flex items-center gap-2">
                                <span className="w-24 text-[11px] font-semibold text-slate-600">MRP</span>
                                <input name="mrp" value={form.mrp} onChange={handleChange} className="flex-1 border border-slate-300 p-1 text-xs outline-none focus:border-blue-500 text-right font-bold" />
                            </div>
                            <div className="flex items-center gap-2">
                                <span className="w-24 text-[11px] font-semibold text-slate-600">Purchase Rate</span>
                                <input name="purchaseRate" value={form.purchaseRate} onChange={handleChange} className="flex-1 border border-slate-300 p-1 text-xs outline-none focus:border-blue-500 text-right" />
                            </div>
                            <div className="flex items-center gap-2">
                                <span className="w-24 text-[11px] font-semibold text-slate-600">Landing Rate</span>
                                <input name="landingRate" value={form.landingRate} onChange={handleChange} className="flex-1 border border-slate-300 p-1 text-xs outline-none focus:border-blue-500 text-right" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="md:col-span-4 flex flex-col gap-2">
                        <div className="bg-white p-3 border border-blue-200 rounded shadow-sm flex-1">
                             ...
                             <div className="space-y-2">
                                <div className="flex items-center gap-2">
                                    ...
                                    <select name="stockType" value={form.stockType} onChange={handleChange} className="flex-1 border border-slate-300 p-1 text-xs outline-none focus:border-blue-500">
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <input name="minimumLevel" value={form.minimumLevel} onChange={handleChange} className="flex-1 border border-slate-300 p-1 text-xs outline-none focus:border-blue-500" />
                                </div>
                                <div className="flex items-center gap-2">
                                    <span className="w-24 text-[11px] font-semibold text-slate-600">Alt Unit</span>
                                    <input name="alternateUnit" value={form.alternateUnit} onChange={handleChange} className="flex-1 border border-slate-300 p-1 text-xs outline-none focus:border-blue-500" />
                                </div>
                                <div className="flex items-center gap-2">
                                    <span className="w-24 text-[11px] font-semibold text-slate-600">Alt Qty</span>
                                    <input name="alternateQty" value={form.alternateQty} onChange={handleChange} className="flex-1 border border-slate-300 p-1 text-xs outline-none focus:border-blue-500" />
                                </div>
                                
                                {/* --- NEW FIELDS ADDED HERE --- */}
                                <div className="flex items-center gap-2">
                                    <span className="w-24 text-[11px] font-semibold text-slate-600">Last Pur. Date</span>
                                    <input 
                                        type="text"
                                        name="lastPurDate" 
                                        value={form.lastPurDate} 
                                        readOnly 
                                        className="flex-1 border border-slate-200 bg-slate-50 p-1 text-xs outline-none text-slate-500 cursor-not-allowed" 
                                        placeholder="Read only"
                                    />
                                </div>
                                <div className="flex items-center gap-2">
                                    <span className="w-24 text-[11px] font-semibold text-slate-600">Last Sales Date</span>
                                    <input 
                                        type="text"
                                        name="lastSalesDate" 
                        ...
                        <div className="bg-white p-3 border border-blue-200 rounded shadow-sm h-32 flex flex-col items-center justify-center text-slate-400">
                ...
                {/* Rate Table and Footer remain the same... */}
                ...
                <div className="flex justify-between items-center bg-white p-2 border border-blue-200 rounded shadow-sm">
                    <button onClick={() => setForm(EMPTY_FORM)} className="flex items-center gap-1.5 px-3 py-1.5 border border-slate-300 rounded font-bold text-slate-700 text-[11px] hover:bg-red-50 hover:text-red-600 transition-all">
                        <RotateCcw size={14} className="text-red-500"/> CLEAR
                    </button>
                    <button className="flex items-center gap-2 px-10 py-1.5 rounded bg-emerald-600 font-black text-white text-[12px] shadow-md hover:bg-emerald-700 transition-all uppercase">
