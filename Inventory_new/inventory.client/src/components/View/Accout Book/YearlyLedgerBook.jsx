...
const YearlyLedgerBook = () => {
  // Mandatory Desktop Structural State
      ...
      <div className="max-w-[98%] mx-auto bg-white shadow-lg rounded-lg overflow-hidden border border-slate-200">
        ...
        <div className="bg-white px-6 py-4 border-b border-slate-100 flex justify-between items-center">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-lg font-bold text-slate-800 tracking-tight">Yearly Ledger Book</h1>
              <p className="text-xs text-slate-500">Solid Solutions | Annual Financials</p>
            </div>
          </div>
        ...
        <div className="p-6 bg-slate-50/50 border-b border-slate-100">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-end">
            <div className="md:col-span-2">
              ...
              <input type="text" value={fromDate} onChange={(e) => setFromDate(e.target.value)} className="w-full border border-slate-300 rounded-lg px-3 py-2 text-sm outline-none focus:border-blue-500 bg-white" />
            </div>
            <div className="md:col-span-2">
              <label className="block text-xs font-bold text-slate-500 uppercase mb-1">To Date</label>
              <input type="text" value={toDate} onChange={(e) => setToDate(e.target.value)} className="w-full border border-slate-300 rounded-lg px-3 py-2 text-sm outline-none focus:border-blue-500 bg-white" />
            </div>
            ...
            <table className="w-full border-collapse">
              <thead className="bg-slate-50 border-b border-slate-200">
                <tr className="text-slate-600 font-bold text-xs uppercase">
                  <th className="text-left py-3 px-4 w-32">Month</th>
                  <th className="text-right py-3 px-4">Debit (Dr)</th>
                  <th className="text-right py-3 px-4">Credit (Cr)</th>
                  <th className="text-right py-3 px-4 w-48">Closing Balance</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-gray-100">
              <tr className="hover:bg-slate-50 transition-colors group cursor-pointer font-medium">
                <td className="py-3 px-4 text-sm text-slate-900">April 2025</td>
                <td className="py-3 px-4 text-sm text-right text-slate-700">₹ 45,200.00</td>
                <td className="py-3 px-4 text-sm text-right text-slate-700">₹ 12,000.00</td>
                <td className="py-3 px-4 text-sm text-right text-blue-600 font-bold">₹ 33,200.00 Dr</td>
              </tr>
            </tbody>
          </table>
        </div>
...
export default YearlyLedgerBook;