...
const JournalBook = () => {
  // State management for mandatory desktop structural fields
  const [fromDate, setFromDate] = useState("01/Jan/2025");
  const [toDate, setToDate] = useState("10/Feb/2026");
      ...
      <div className="max-w-[98%] mx-auto bg-white shadow-lg rounded-lg overflow-hidden border border-slate-200">
        ...
        <div className="bg-white px-6 py-4 border-b border-slate-100 flex justify-between items-center">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-lg font-bold text-slate-800 tracking-tight">Journal Book</h1>
              <p className="text-xs text-slate-500">Solid Solutions | Accounting Reports</p>
            </div>
          </div>
          ...
          <div className="border border-slate-200 rounded-lg overflow-hidden">
            <table className="w-full border-collapse">
              <thead className="bg-slate-50 border-b border-slate-200">
                <tr className="text-slate-600 font-bold text-xs uppercase">
                  ...
                  <th className="text-left py-3 px-4">Particulars / Account Name</th>
                  <th className="text-left py-3 px-4 w-32">Vch Type</th>
            ...
            <tbody className="divide-y divide-gray-100">
              <tr className="hover:bg-slate-50 transition-colors group cursor-pointer">
                <td className="py-3 px-4 text-sm text-slate-500">01/Jan/2025</td>
                <td className="py-3 px-4 text-sm">
                  <div className="text-gray-900 font-bold">Office Rent A/c</div>
                  <div className="text-gray-500 italic ml-4">To Cash A/c</div>
                  <div className="text-[10px] text-blue-500 mt-1 uppercase tracking-tighter">Narration: Paid rent for January</div>
                </td>
                <td className="py-3 px-4 text-sm text-slate-500 font-medium uppercase">Journal</td>
                <td className="py-3 px-4 text-sm text-right text-slate-900 font-bold">₹ 15,000.00</td>
                <td className="py-3 px-4 text-sm text-right text-slate-900 font-bold">₹ 15,000.00</td>
              </tr>
            </tbody>
          </table>
