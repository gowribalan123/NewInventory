...
const NegativeStockRegister = () => {
  ...
  // Sample data
  const data = [
    { itemName: "CP PLUS 2.4MP DOME", company: "CP PLUS", stock: "-5.00" },
    { itemName: "HIKVISION 2MP BULLET", company: "HIKVISION", stock: "-12.00" },
  ];
          ...
          <table className="w-full">
            ...
            <tbody>
              {data.map((row, idx) => (
                <tr key={idx} className="border-b border-gray-100 table-row-hover cursor-pointer">
                  ...
                  <td className="px-6 py-4 text-sm text-right font-bold text-red-600 font-mono">
                    {row.stock}
                  </td>
                </tr>
              ))}
            ...
            <tfoot>
              <tr className="bg-gradient-to-r from-blue-50 to-gray-50 border-t-2 border-blue-200">
                ...
                <td className="px-6 py-4 text-sm text-right font-bold text-red-700 text-base">
                  -17.00
                </td>
              </tr>
            </tfoot>
...
export default NegativeStockRegister;