...
export default function Administrator() {
  ...
  const handleSave = () => {
    if (validateForm()) {
      console.log("Saving administrator:", formData);
      alert("Administrator settings saved successfully!");
    }
  };
        ...
        <div className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-blue-100 mt-0.5">
                  Manage administrator credentials and settings
                </p>
              </div>
            </div>
          ...
          <div className="p-8">
            <div className="max-w-2xl mx-auto space-y-6">
              ...
              {/* Display Bank Ledgers */}
              <div className="pt-4 border-t border-gray-200">
                <label className="flex items-center gap-3 cursor-pointer group">
                  <input
                    type="checkbox"
                    name="displayBankLedgers"
                    checked={formData.displayBankLedgers}
                    onChange={handleChange}
                ...
                <p className="text-xs text-gray-500 mt-1 ml-8">
                  Show bank ledgers in reports and statements
                </p>
              </div>
            </div>
          </div>
