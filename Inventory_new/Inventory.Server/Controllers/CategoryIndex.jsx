          ...
          <tbody>
            {categories.map((item) => (
              <tr key={item.categoryId} className="border-b hover:bg-gray-50">
                ...
                <td className="px-4 py-3 text-gray-500">{item.categoryCode || "-"}</td>
            ...
            {categories.length === 0 && <tr><td colSpan="4" className="px-4 py-6 text-center text-gray-400">No categories found</td></tr>}
          </tbody>
        </table>
      </div>
    </div>
